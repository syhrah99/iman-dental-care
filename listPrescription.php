...
$result = $conn->query( "SELECT appointment.nric, prescription.*, treatment.treatment_type from prescription join treatment on treatment.treatment_id=prescription.treatment_id join appointment on treatment.appointment_id= appointment.appointment_id where appointment.staff_id= '$staff_id'  ");
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header bg-info">
                <h4 class="modal-title" style="color: white;" id="memberModalLabel">Suggested Drugs</h4>
        ...
        <div class="container">
            <div id="main">
                    ...
                    <table class="container" style="width: 100%; margin: 0 auto;" id="myTable">
                        <thead>
                                <tr>
                                    <th scope="col" style="//width: 120px;" >Patient NRIC</th>
                                        ...
                                        while($mem = mysqli_fetch_array($result)):
                                         ...
                                         echo '<td>
                                                       <a class="btn btn-small btn-primary"
                                                          ...
                                                          data-prescription_id="'.$mem['prescription_id'].'">Drugs</a>

                                                        <a class="btn btn-small btn-success"
                                                          data-toggle="modal"
                                                          data-target="#viewModal"
                                                          data-prescription_id="'.$mem['prescription_id'].'">View</a>

...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header bg-info">
                <h4 class="modal-title" style="color: white;" id="memberModalLabel">Update Drugs Details</h4>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header bg-danger">
                <h4 class="modal-title" style="color: white;" id="memberModalLabel">Delete Drug </h4>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    ...
                    <table class="container" style="width: 100%; margin: 0 auto;" id="myTable">
                        <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="//width: 380px;">Quantity</th>
                                    <th scope="col" style="//width: 380px;">Expiry Date</th>                                   
                                    <th scope="col" style="//width: 380px;">Price</th>
                                     <th scope="col" style="//width: 380px;">&emsp;&emsp;&emsp; Action</th>
                                </tr>
                            </thead>
                            <tbody>
                              ...
                              <?php
                                        ...
                                        while($mem = mysqli_fetch_array($result)):
                                           ...
                                           echo '<tr>';
                                              echo '<td>'.$mem['med_name'].'&emsp;&emsp;</td>';
                                              echo '<td>'.$mem['quantity'].'&emsp;&emsp;</td>';
                                              echo '<td>'.$mem['expiry_date'].'&emsp;&emsp;</td>';
                                              echo '<td>'.$mem['price'].' &emsp;&emsp;&emsp;&emsp;</td>'; 
                                              
                                              echo '<td>
                                                       <a class="btn btn-small btn-primary"
                                                          data-toggle="modal"
                                                          data-target="#updateModal"
                                                          data-drugs_id="'.$mem['drugs_id'].'">Update</a> &nbsp;

                                                          <a class="btn btn-small btn-danger"
                                                          data-toggle="modal"
                                                          data-target="#deleteModal"
                                                          data-drugs_id="'.$mem['drugs_id'].'">Delete</a> 
...
<script>
    $('#updateModal').on('show.bs.modal', function (event) {
          ...
          var recipient = button.data('drugs_id') // Extract info from data-* attributes
          var modal = $(this);
          var dataString = 'drugs_id=' + recipient;

            $.ajax({
                type: "GET",
                url: "./process/updateDrugs.php",
                data: dataString,
                cache: false,

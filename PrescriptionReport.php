    ...
    <div id="main">
			...
			?>
				  ...
				  <div class="row">
					...
					<div class="col-75">
					  <input type="text" name="prescription_id"  value="<?php echo $prescription_id?>" placeholder="<?php echo $prescription_id?>" readonly>
					</div>
				  </div>
				  ...
				  <div class="row">
					...
					<div class="col-75">
						<table class="table" style="text-align:center; color: white;">
							...
							echo "<h3>"."<tr><th>ID</th><th>Name</th><th>quantity</th>";
							$sqlD="select * from prescription_detail where prescription_id = '$prescription_id'";
							$resD=$conn->query($sqlD);
								...
								while($row=$resD->fetch_assoc()){
									...
									$res=$conn->query($sql);
										...
										{	
											echo "<tr><td>".$row1["drugs_id"]."</td><td>". $row1["med_name"]."</td><td>". $row["quantity"]."</td>";
										}
								}
